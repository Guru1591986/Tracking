<%@ Page Title="Home Page" Language="C#"  AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="Courier_Tracking._Default" %>


 <link href="//netdna.bootstrapcdn.com/bootstrap/3.1.0/css/bootstrap.min.css" rel="stylesheet" id="bootstrap-css">
    
 <link href="//netdna.bootstrapcdn.com/font-awesome/4.0.3/css/font-awesome.css" rel="stylesheet" id="-css">
...
.shop-tracking-status .image-order-status-completed .status:after{font-family:FontAwesome;content:"\f054";padding-left:5px;vertical-align:middle}
  ...
  <%--<link href="https://code.jquery.com/ui/1.10.3/themes/smoothness/jquery-ui.css" rel="stylesheet">--%>
    <link href="https://kkrowten.com/templates/templates2/css/bootstrap.min.css" rel="stylesheet" />
    <link href="https://kkrowten.com/MWH/KCss/css/Validations.css" rel="stylesheet" />

    <link href="https://kkrowten.com/templates/templates2/css/style.css" rel="stylesheet" />
  
    <link href="https://kkrowten.com/templates/OpensiteCSS/css/font-awesome.min.css" rel="stylesheet" />

    <link href="https://fonts.googleapis.com/css?family=Open+Sans:400,700" rel="stylesheet">
    <script src="https://kkrowten.com/templates/templates2/js/jquery.js"></script>
    <script src="https://kkrowten.com/templates/templates2/js/bootstrap.min.js"></script>

    <script src="https://cdnjs.cloudflare.com/ajax/libs/moment.js/2.10.6/moment.min.js"></script>
    <script src="//ajax.googleapis.com/ajax/libs/jqueryui/1.10.2/jquery-ui.min.js"></script>

    <link href="https://kkrowten.com/js/Alertify/alertify.core.css" rel="stylesheet" />
    <link href="https://kkrowten.com/js/Alertify/alertify.default.css" rel="stylesheet" />
    <script src="https://kkrowten.com/js/Alertify/alertify.min.js"></script>
    <script src="https://kkrowten.com/js/aes.js"></script>


    <link href="https://kkrowten.com/js/Notify/notify.css" rel="stylesheet" />
    <script src="https://kkrowten.com/js/Notify/notify.js"></script>

    <base href="/">  
     
  	<!-- Global site tag (gtag.js) - Google Analytics -->
	<script async src="https://www.googletagmanager.com/gtag/js?id=UA-110486935-1"></script>
	<script>
  		window.dataLayer = window.dataLayer || [];
  		function gtag(){dataLayer.push(arguments);}
  		gtag('js', new Date());

  		gtag('config', 'UA-110486935-1');
	</script>
    ...
    <div class="col-md-12">
        <div class="well">
            ...
            <div align="center"    class="form-horizontal">
                ...
                <div>&nbsp;</div>
             <table >
                <tr><td><b>AWB NUMBER :</b></td><td><asp:Label ID="oid" runat="server" ></asp:Label></td><td><b>ORDER NUMBER:</b></td><td><asp:Label ID="onum" runat="server" ></asp:Label></td></tr>
                <tr><td><b>CURRENT STATUS:</b></td><td><asp:Label ID="sts" runat="server" ></asp:Label></td><td><b>STATUS DATE:</b></td><td><asp:Label ID="dat_lbl" runat="server" ></asp:Label></td></tr>
                </table> 
       ...
       <%--           
         <div  class='order-status-timeline'>
               ...
               <div class='image-order-status image-order-status-new active img-circle'> <span class='status'>Accepted</span> <div class="icon"></div></div>
                   
                   
                
                <div class='image-order-status image-order-status-active active img-circle'><span class='status'>In progress</span><div class="icon"></div></div>
                    
                    
                
                <div class='image-order-status image-order-status-intransit active img-circle'>  <span class='status'>Shipped</span><div class="icon"></div> </div>
                  
                    
               
                <div class='image-order-status image-order-status-delivered active img-circle'><span class='status'>Delivered</span>  <div class="icon"></div> </div>
                    
                  
               
               <div class='image-order-status image-order-status-completed active img-circle'><span class='status'>Completed</span><div class="icon"></div></div>--%>
           ...
           <%--  <h4>Your order status:</h4>
            <ul class="list-group">
                <li class="list-group-item">
            <span class="prefix"> Update Date:</span>
                   <asp:Label ID="Loc_lbl" runat="server"  class="label label-success" ></asp:Label>
            </li>

                 <li class="list-group-item">
                    <span class="prefix">Status:</span>
                  <asp:Label ID="sts_lbl" runat="server"  class="label label-success" ></asp:Label>
                </li>
            </ul>--%>

               <div id="divTable1" runat="server"> </div>
